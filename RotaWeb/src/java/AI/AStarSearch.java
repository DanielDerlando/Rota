...
public class AStarSearch {
    ...
    public String search(Problem p, Heuristic h) {
        ...
        ComparatorRoute cR = new ComparatorRoute(h);
        ...
        while (executando) {
            if (frontier.isEmpty()) {
                ...
                double var = n.getPathCost() + h.calculate(n.getS());
                        ...
                        if (!(exploredSet.contains(child) || frontier.contains(child))) {
                            ...
                            if (frontier.contains(child)) {
                                ...
                                while (i.hasNext() && !b) {
                                    ...
                                    if (b) {
                                        d = n2.getPathCost() + h.calculate(n2.getS());
                                        d1 = child.getPathCost() + h.calculate(child.getS());
                                        if (d > d1) {
